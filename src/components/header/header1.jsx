import { Box, Button, Center, Flex, HStack, Heading, Text } from "@chakra-ui/react";
    ...
    <header className={`header ${mobileMenu ? "mobileView" : ""} ${show}`}>
      ...
      {showSearch && (
        <div className="searchBar">
          <ContentWrapper>
            <div style={{width:"100%",color:"black",padding:'2rem',backgroundColor:"gray",borderRadius:"2rem",display:"flex",justifyContent:"center",alignContent:"center"}} className="searchInput">
              <input
                type="text"
